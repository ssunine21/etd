...
{
    public class ControllerBulletPLSS : ControllerBullet
    {
        public int FlameRate { get; set; } = 3;
        public float AttackCoefficient { get; set; } = DataController.Instance.elementalCombine.GetAttackCoefficient("PLSS");
        
        private readonly ViewBulletPLC _view;
        
        public ControllerBulletPLSS(CancellationTokenSource cts, Transform parent)
