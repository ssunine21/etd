...
{
    public class ControllerBulletLDC : ControllerBullet
    {
        private readonly ViewBulletLDC _view;
        
        public ControllerBulletLDC(CancellationTokenSource cts, Transform parent)
            : base(cts, parent,  View.View.Get<ViewBulletLDC>())
        {
            _view = (ViewBulletLDC)viewBullet;
        }
