...
{
    public class ControllerBulletAFA : ControllerBullet
    {
        private readonly ViewBulletAFA _view;
        
        public ControllerBulletAFA(CancellationTokenSource cts, Transform parent) : base(cts, parent,  InGame.View.View.Get<ViewBulletAFA>())
        {
            _view = (ViewBulletAFA)viewBullet;
