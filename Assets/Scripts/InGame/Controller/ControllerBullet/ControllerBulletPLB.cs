...
{
    public class ControllerBulletPLB : ControllerBullet
    {
        public int FlameRate { get; set; } = 1;
        public float AttackCoefficient { get; set; } = DataController.Instance.elementalCombine.GetAttackCoefficient("PLB");
        private readonly ViewBulletPLC _view;
        
        public ControllerBulletPLB(CancellationTokenSource cts, Transform parent)
