...
{
    public class ControllerBulletPDC : ControllerBullet
    {
        public int CircleCount { get; set; } = 1;
        
        private readonly ViewBulletPDC _view;
        
        public ControllerBulletPDC(CancellationTokenSource cts, Transform parent)
        ...
        public override async UniTaskVoid Shot(Vector2 basePosition, HashSet<IDamageable> nonTargets = null)
        {
            for (var i = 0; i < CircleCount; i++)
            {
                ...
                ((ControllerBulletDarkCircle)bullet).SetActiveEmber(i % 2 == 0 && i < 4);
