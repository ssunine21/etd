...
{
    public class ControllerBulletAIC : ControllerBullet
    {
        private readonly ViewBulletAIC _view;
        
        public ControllerBulletAIC(CancellationTokenSource cts, Transform parent)
            : base(cts, parent,  View.View.Get<ViewBulletAIC>())
        {
            _view = (ViewBulletAIC)viewBullet;
