...
{
    public class ControllerBulletPDA : ControllerBullet
    {
        public int CircleCount { get; set; } = 3;
        
        private readonly ViewBulletPDC _view;
        
        public ControllerBulletPDA(CancellationTokenSource cts, Transform parent)
