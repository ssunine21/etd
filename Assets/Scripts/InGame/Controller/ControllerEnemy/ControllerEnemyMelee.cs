...
{
    public class ControllerEnemyMelee : ControllerEnemy
    {
        private readonly ViewEnemyMelee _view;
        private ParticleSystem _attackParticle;
        
        public ControllerEnemyMelee(CancellationTokenSource cts) 
            : base(cts, InGame.View.View.Get<ViewEnemyMelee>("Enemy"), EnemyType.Melee)
        {
            _view = (ViewEnemyMelee)viewEnemy;
